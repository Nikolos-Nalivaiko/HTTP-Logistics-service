...
<head>
    ...
    <title>HTTP - Відновлення даних</title>
    ...
    <div class="main-wrapper">
        ...
        <main>
            <section class="restore">
                <div class="container">
                    <h2>Оберіть тип відновлення</h2>

                    <a href="restore-pass.php" class="restore-block__restore">
                        <img src="img/pass-restore.svg" class="icon__restore">
                        <div class="wrap-text__restore">
                            <p class="headline-block__restore">Скидання паролю</p>
                            <p class="descript-block__restore">Якщо ви забули свій пароль, ви можете скинути старий та
                                увійти до свого профілю за допомогою тимчасового нового паролю </p>
                        </div>
                    </a>

                    <a href="restore-login.php" class="restore-block__restore">
                        <img src="img/log-restore.svg" class="icon__restore">
                        <div class="wrap-text__restore">
                            <p class="headline-block__restore">Відновлення логіну</p>
                            <p class="descript-block__restore">Якщо ви забули свій логін, ви можете відновити його за
                                допомогою паролю та особистих даних, таких як номер телефону до якого прив'язаний
                                профіль</p>
                        </div>
                    </a>
