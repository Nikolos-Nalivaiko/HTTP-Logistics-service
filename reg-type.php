...
<body>
    <div class="main-wrapper">
        ...
        <main>
            <section class="section__reg-type">
                <div class="container">
                    <h2>Оберіть тип акаунту</h2>
                    <p class="descript__reg-type">Оберіть тип профілю “Підприємство” або “Фізична особа”, в залежності
                        від вибраного типу в подальшому це буде відображено іншим користувачам</p>

                    <div class="wrap-card__reg-type">
                        <a href="reg-company.php" class="card__reg-type">
                            <img src="img/company__reg-type.svg" class="icon-card__reg-type">
                            <p class="headlinr-card__reg-type">Підприємство</p>
                        </a>

                        <a href="register-user.php" class="card__reg-type">
                            <img src="img/user__reg-type.svg" class="icon-card__reg-type">
                            <p class="headlinr-card__reg-type">Фізична особа</p>
                        </a>
                    </div>
                </div>
            </section>
